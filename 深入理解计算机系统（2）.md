...
![image-20220122174138189](https://raw.githubusercontent.com/shizhengLi/image_bed_01/main/img/image-20220122174138189.png)
...
![image-20220122160904349](https://raw.githubusercontent.com/shizhengLi/image_bed_01/main/img/image-20220122160904349.png)
...
![image-20220122163313863](https://raw.githubusercontent.com/shizhengLi/image_bed_01/main/img/image-20220122163313863.png)
...
![image-20220122170204892](https://raw.githubusercontent.com/shizhengLi/image_bed_01/main/img/image-20220122170204892.png)
...
调用递归函数`sum(3)`具体汇编代码运行过程：

```bash
azheng@lishizheng:/mnt/e/csapp_bilibili/ass_first_refactory$ make hardware
/usr/bin/gcc-9 -Wall -g -O2 -Werror -std=gnu99 -Wno-unused-function -I./src ./src/common/print.c ./src/common/convert.c ./src/hardware/cpu/mmu.c ./src/hardware/cpu/isa.c ./src/hardware/memory/dram.c  ./src/main_hardware.c -o exe_hardware
./exe_hardware
begin
400400    mov    $0x3,%edi
...
![image-20220122171532829](https://raw.githubusercontent.com/shizhengLi/image_bed_01/main/img/image-20220122171532829.png)
